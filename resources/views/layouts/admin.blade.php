...
{{-- Navbar horizontal --}}
    <nav class="bg-custom p-4 h-25" >
      ...
      <aside class="bg-custom flex w-72 flex-col space-y-2 border-r-2 border-green-600 bg-white p-2" style="height: 90.5vh"
            ...
            <a href="{{ route('admin.order.index') }}" class="bg-gray-100 flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-yellow-600 hover:text-gray-200">
                <span class="text-2xl"><i class="bx bx-cart"></i></span>
                <span>Orders</span>
            </a>

            <a href="{{ route('admin.products.index') }}" class="bg-gray-100 flex items-center space-x-1 rounded-md px-2 py-3 hover:bg-yellow-600 hover:text-gray-200">
