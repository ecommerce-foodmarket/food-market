...
<button class="bg-blue shadow hover:bg-green-600 focus:shadow-outline focus:outline-none mt-10 text-white font-bold py-2 px-4 rounded"><a href="{{route('admin.products.create')}}">+ Add Menu</a></button>
              ...
              <div >
                ...
                <div class="flex mt-4 space-x-3  mb-6 h-20 justify-around content-center">
                    <div class="flex flex-row">
                        <button class="bg-green inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"><a href="{{ route('admin.products.edit', $product->id) }}">EDIT</a></button>
                    </div>
